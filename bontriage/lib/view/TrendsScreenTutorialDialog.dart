...
class _TrendsScreenTutorialDialogState extends State<TrendsScreenTutorialDialog> {
  ...
  GlobalKey _graphBoxGlobalKey;
  GlobalKey _arrowUpBoxGlobalKey;
  Offset _dotOffset;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      RenderBox dotRenderBox = _dotGlobalKey.currentContext.findRenderObject();
      _dotOffset = dotRenderBox.localToGlobal(Offset.zero);
      print('DotOffset???$_dotOffset');
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Visibility(
                      visible: _currentIndex == 3,
                      child: Padding(
                        padding: EdgeInsets.only(left: (_dotOffset == null) ? 0 : _dotOffset.dx - 30),
                        child: Image(
                          image: AssetImage(
...
class TrendsTutorialClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    switch(currentIndex) {
      ...
      case 1:
      case 2:
        RenderBox dotsRenderBox = dotBoxGlobalKey.currentContext.findRenderObject();
      ...
      case 3:
        RenderBox graphRenderBox = graphBoxGlobalKey.currentContext.findRenderObject();
