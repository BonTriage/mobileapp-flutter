...
class Constant {
  ...
  static String welcomeStartAssessmentScreenRouter = '/welcomeStartAssessmentScreenRouter';
  static String onBoardHeadacheInfoScreenRouter = '/onBoardHeadacheInfoScreenRouter';
  ...
  static String beforeContinuing = 'Before continuing, please create a secure account with us so that we can track you progress.';
  static String createAccount = 'Create Account';
  static String nextWeAreGoing = 'Next, we are going to find out what kind of headaches you have. If you have more than one type of headache, let’s focus on the one that’s most bothersome to you.';
  static String answeringTheNext = 'Answering the next set of 14 brief questions will give us a good idea of your headache type. Stick with us. It will be worth it!';
  static String continueText = 'Continue';
  static String moveOnForNow = 'Move On For Now';
  static String experienceTypesOfHeadaches = 'If you experience other types of headaches, you can complete a similar assessment for them either now or later in the app.';
  static String almostReadyToHelp = 'We’re almost ready to help you start getting your headaches under better control. To really understand your headaches, we need to know what you have already learned about what has helped—and what has not worked or has worsened—your headaches.';
  static String quickAndEasySection = 'For some people, this is a quick and easy section; for others, it can take some serious thinking back, but you will find it worth the effort as we move forward. There are only five more questions.';
  static String setUpNotifications = 'Set Up Notifications';
  static String qualityOfOurMentorShip = 'Here is where we can start helping you. The quality of our mentorship is dependent on how much accurate information you provide. It usually takes less than two minutes to log your daily behaviors and potential triggers; doing so everyday yields the best results.';
  static String easyToLoseTrack = 'We know it can be easy to lose track of this, and we found it works best if you let us send you a daily reminder — we recommend the late afternoon or evening. Can we set that up for you?';
  ...
  static String personalizedUnderstanding = 'Get a personalized understanding of your migraines and headaches through tools developed by leading board-certified migraine and headache and specialists.';
