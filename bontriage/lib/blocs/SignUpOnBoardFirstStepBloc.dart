...
class SignUpOnBoardFirstStepBloc {
  SignUpOnBoardFirstStepRepository _welcomeOnBoardProfileRepository;
  ...
  SignUpOnBoardFirstStepBloc({this.count = 0}) {
    _signUpFirstStepDataStreamController = StreamController<dynamic>();
    _welcomeOnBoardProfileRepository = SignUpOnBoardFirstStepRepository();
  }
