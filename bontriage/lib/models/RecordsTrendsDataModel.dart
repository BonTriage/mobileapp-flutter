...
String recordsTrendsDataModelToJson(RecordsTrendsDataModel data) => json.encode(data.toJson());
...
class Behavior {
  ...
  factory Behavior.fromJson(Map<String, dynamic> json) => Behavior(
    ...
    data: List<BehaviorDatum>.from(json["data"].map((x) => BehaviorDatum.fromJson(x))),
  );
...
class BehaviorDatum {
  ...
  Map<String, dynamic> toJson() => {
    "behavior.preexercise": behaviorPreexercise == null ? null : behaviorPreexercise,
...
class Medication {
  ...
  factory Medication.fromJson(Map<String, dynamic> json) => Medication(
    date: DateTime.parse(json["date"]),
    data: List<MedicationDatum>.from(json["data"].map((x) => MedicationDatum.fromJson(x))),
  );
...
class Trigger {
  ...
  factory Trigger.fromJson(Map<String, dynamic> json) => Trigger(
    date: DateTime.parse(json["date"]),
    data: List<TriggerDatum>.from(json["data"].map((x) => TriggerDatum.fromJson(x))),
  );
